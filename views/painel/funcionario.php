...
<body class="layout">
    <aside class="sidebar">
        <h2 class="logo">Funcionário</h2>
        <nav>
            <ul>
                <li><a href="../usuario/listar_clientes.php"><i class="fas fa-user-plus"></i> Login de Cliente</a></li>
                <li><a href="../cliente/listar.php"><i class="fas fa-users" aria-hidden="true"></i> Clientes</a></li>
                <li><a href="../produto/listar.php"><i class="fas fa-box" aria-hidden="true"></i> Produtos</a></li>
                <li><a href="../estoque/listar.php"><i class="fas fa-chart-bar" aria-hidden="true"></i> Estoque</a></li>
    ...
    <main class="main">
        ...
        <div class="card-grid">
            ...
            <a href="../usuario/cadastrar_cliente.php" class="card">
                <i class="fas fa-users fa-2x" aria-hidden="true"></i><br><span>Login de Cliente</span>
            </a>
            <a href="../produto/listar.php" class="card">
                <i class="fas fa-box fa-2x" aria-hidden="true"></i><br><span>Produtos</span>
            </a>
            <a href="../estoque/listar.php" class="card">
                <i class="fas fa-chart-bar fa-2x" aria-hidden="true"></i><br><span>Estoque</span>
            </a>
